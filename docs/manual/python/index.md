...
- [Environments & pip](basics/venv_pip.md)
...
- [I/O Patterns](io.md)
- [Pathlib & Filesystem](modules/pathlib.md)
- [Subprocess](modules/subprocess.md)
- [Logging](modules/logging.md)
- [CLI and argparse](modules/cli.md)
 - [Serialization](modules/serialization.md)
 - [Regex](modules/regex.md)
  - [Datetime & Timezones](modules/datetime_tz.md)
  - [Packaging & Publishing](modules/packaging.md)
  - [Dataclasses](modules/dataclasses.md)
  - [Itertools + Functools](modules/itertools_functools.md)
  - [Configuration](modules/config.md)
  - [SQLite](modules/sqlite.md)
  - [Networking](modules/networking.md)
  - [Security Basics](modules/security.md)
  - [DB Patterns](modules/db_patterns.md)
  - [Enums](modules/enum.md)
  - [Memory-Mapped Files](modules/mmap.md)
